...
//($sort) - сортируем по возрасту (убывающе), ($limit: 3) - ограничиваем вывод до 3х, ($project) - выводим только имя
// db.students.aggregate([{$sort: {age: -1}}, {$limit: 3}, {$project: {name: 1, _id: 0}}]);
